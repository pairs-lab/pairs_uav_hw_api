...
#include <pairs_msgs/HwApiRcChannels.h>
#include <pairs_msgs/RtkGps.h>
#include <pairs_msgs/RtkFixType.h>
#include <pairs_msgs/GpsInfo.h>

#include <pairs_msgs/HwApiAltitude.h>
...
typedef std::function<void(const pairs_msgs::GpsInfo &msg)>        publishGNSSStatus_t;
typedef std::function<void(const pairs_msgs::RtkGps &msg)>                 publishRTK_t;
typedef std::function<void(const pairs_msgs::HwApiAltitude &msg)>          publishAltitude_t;
typedef std::function<void(const pairs_msgs::Float64Stamped &msg)>         publishMagnetometerHeading_t;
typedef std::function<void(const sensor_msgs::MagneticField &msg)>       publishMagneticField_t;
typedef std::function<void(const pairs_msgs::HwApiStatus &msg)>            publishStatus_t;
typedef std::function<void(const pairs_msgs::HwApiRcChannels &msg)>        publishRcChannels_t;
